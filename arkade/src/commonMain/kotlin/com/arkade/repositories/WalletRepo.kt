 ...
 *
 * @param wallet The wallet to persist. Implementations should store the wallet so it can be retrieved later.
 */
 ...
 *
 * @param wallet Wallet containing updated values; its identifier is used to locate the existing record to modify.
 */
